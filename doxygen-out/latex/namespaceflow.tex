...
{\footnotesize template$<$typename ReturnT , typename Unary\+InvocableT , typename Arg\+TupleT $>$ }\\constexpr std\+::enable\+\_\+if$<$!std\+::is\+\_\+void$<$ ReturnT $>$\+::value, ReturnT $>$\+::type \mbox{\hyperlink{namespaceflow_a6455569ea0cc7a2f8e9ab470ce1ccf5c}{apply}} (Unary\+InvocableT \&\&fn, Arg\+TupleT \&\&targs)
\begin{DoxyCompactList}\small\item\em Calls function with with tuple (e.\+g {\ttfamily std\+::tuple}) as argument list. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Unary\+InvocableT , typename Arg\+TupleT $>$ }\\constexpr void \mbox{\hyperlink{namespaceflow_a4f23fc70281849dfd0c21efe1471df22}{apply\+\_\+every}} (Unary\+InvocableT \&\&fn, Arg\+TupleT \&\&targs)
\begin{DoxyCompactList}\small\item\em Calls function on every element of a tuple (e.\+g {\ttfamily std\+::tuple}) \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Binary\+InvocableT , typename Arg1\+TupleT , typename Arg2\+TupleT $>$ }\\constexpr void \mbox{\hyperlink{namespaceflow_ad8a042fc4ba754e378d2e3e40ba1b9d9}{apply\+\_\+every}} (Binary\+InvocableT \&\&fn, Arg1\+TupleT \&\&targs1, Arg2\+TupleT \&\&targs2)
\begin{DoxyCompactList}\small\item\em Calls a binary function on each element of two tuples (e.\+g {\ttfamily std\+::tuple}) \end{DoxyCompactList}\item 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{namespaceflow_a6455569ea0cc7a2f8e9ab470ce1ccf5c}\label{namespaceflow_a6455569ea0cc7a2f8e9ab470ce1ccf5c}} 
\index{flow@{flow}!apply@{apply}}
\index{apply@{apply}!flow@{flow}}
\doxysubsubsection{\texorpdfstring{apply()}{apply()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily template$<$typename ReturnT , typename Unary\+InvocableT , typename Arg\+TupleT $>$ \\
constexpr std\+::enable\+\_\+if$<$!std\+::is\+\_\+void$<$ReturnT$>$\+::value, ReturnT$>$\+::type flow\+::apply (\begin{DoxyParamCaption}\item[{Unary\+InvocableT \&\&}]{fn,  }\item[{Arg\+TupleT \&\&}]{targs }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [constexpr]}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{namespaceflow_ad8a042fc4ba754e378d2e3e40ba1b9d9}\label{namespaceflow_ad8a042fc4ba754e378d2e3e40ba1b9d9}} 
\index{flow@{flow}!apply\_every@{apply\_every}}
\index{apply\_every@{apply\_every}!flow@{flow}}
\doxysubsubsection{\texorpdfstring{apply\_every()}{apply\_every()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily template$<$typename Binary\+InvocableT , typename Arg1\+TupleT , typename Arg2\+TupleT $>$ \\
constexpr void flow\+::apply\+\_\+every (\begin{DoxyParamCaption}\item[{Binary\+InvocableT \&\&}]{fn,  }\item[{Arg1\+TupleT \&\&}]{targs1,  }\item[{Arg2\+TupleT \&\&}]{targs2 }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [constexpr]}}



Calls a binary function on each element of two tuples (e.\+g {\ttfamily std\+::tuple}) 


\begin{DoxyTemplParams}{Template Parameters}
{\em Binary\+InvocableT} & (deduced) binary invocable type\+:
\begin{DoxyItemize}
\item function pointer
\item functor object with {\ttfamily Object\+::operator()}
\item lambda function expression 
\end{DoxyItemize}\\
\hline
{\em Arg1\+TupleT} & (deduced) tuple-\/like type with element types order according to function argument list \\
\hline
{\em Arg2\+TupleT} & (deduced) tuple-\/like type with element types order according to function argument list\\
\hline
\end{DoxyTemplParams}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{namespaceflow_a4f23fc70281849dfd0c21efe1471df22}\label{namespaceflow_a4f23fc70281849dfd0c21efe1471df22}} 
\index{flow@{flow}!apply\_every@{apply\_every}}
\index{apply\_every@{apply\_every}!flow@{flow}}
\doxysubsubsection{\texorpdfstring{apply\_every()}{apply\_every()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily template$<$typename Unary\+InvocableT , typename Arg\+TupleT $>$ \\
constexpr void flow\+::apply\+\_\+every (\begin{DoxyParamCaption}\item[{Unary\+InvocableT \&\&}]{fn,  }\item[{Arg\+TupleT \&\&}]{targs }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [constexpr]}}



Calls function on every element of a tuple (e.\+g {\ttfamily std\+::tuple}) 


\begin{DoxyTemplParams}{Template Parameters}
{\em Unary\+InvocableT} & (deduced) unary invocable type\+:
\begin{DoxyItemize}
\item function pointer
\item functor object with {\ttfamily Object\+::operator()}
\item lambda function expression 
