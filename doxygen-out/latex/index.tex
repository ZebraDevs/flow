...
{\ttfamily \mbox{\hyperlink{classflow_1_1_captor}{flow\+::\+Captor}}} objects are data buffers with an associated synchronization policy. They are used in tuples to synchronize several streams of data. {\ttfamily \mbox{\hyperlink{classflow_1_1_captor}{flow\+::\+Captor}}} objects fall into two categories\+:


\begin{DoxyItemize}
\item {\ttfamily \mbox{\hyperlink{classflow_1_1_driver}{flow\+::\+Driver}}} captors, which establish a time range for synchronization
\item {\ttfamily \mbox{\hyperlink{classflow_1_1_follower}{flow\+::\+Follower}}} captors, which select buffered data based on a driving sequencing range
\end{DoxyItemize}

{\ttfamily \mbox{\hyperlink{classflow_1_1_captor}{flow\+::\+Captor}}} objects from both categories will\+:
...
Additionally, {\ttfamily \mbox{\hyperlink{classflow_1_1_captor}{flow\+::\+Captor}}} objects were designed to\+:
...
{\ttfamily \mbox{\hyperlink{classflow_1_1_synchronizer}{flow\+::\+Synchronizer}}} provides methods for operating on {\ttfamily \mbox{\hyperlink{classflow_1_1_captor}{flow\+::\+Captor}}} objects as a group (arranged as a tuple). The {\ttfamily \mbox{\hyperlink{classflow_1_1_synchronizer}{flow\+::\+Synchronizer}}} can be used to retrieve synchronized data between several buffers like so\+:
...
The {\ttfamily \mbox{\hyperlink{classflow_1_1_synchronizer}{flow\+::\+Synchronizer}}} may also be used to {\itshape test} if capture is possible across all {\ttfamily \mbox{\hyperlink{classflow_1_1_captor}{flow\+::\+Captor}}} objects without changing the results of the next data capture\+:
...
\begin{DoxyItemize}
\item See these \href{flow/test/unit/synchronizer_mt_example.cpp}{\texttt{ test cases}} for examples of {\ttfamily \mbox{\hyperlink{classflow_1_1_synchronizer}{flow\+::\+Synchronizer}}} in action in a multi-\/threaded context.
\item See this \href{flow/test/unit/synchronizer_st_example.cpp}{\texttt{ test case}} for an example of {\ttfamily \mbox{\hyperlink{classflow_1_1_synchronizer}{flow\+::\+Synchronizer}}} in action in a single-\/threaded context.
\end{DoxyItemize}

\doxysubsubsection*{Dispatch}

A {\ttfamily Dispatch} is a conceptual object used to represent and access key information about data within {\ttfamily \mbox{\hyperlink{classflow_1_1_captor}{flow\+::\+Captor}}} buffers. Essentially, {\ttfamily Dispatch} objects have both data payload and sequencing information. An implementation which fulfills the {\ttfamily Dispatch} concept can be customized per use case.
...
This library provides a default {\ttfamily \mbox{\hyperlink{classflow_1_1_dispatch}{flow\+::\+Dispatch}}$<$StampT, DataT$>$} object template, which is essentially just a slightly more descriptive {\ttfamily std\+::pair} for a stamp and a value. All required companion facilities have been provided for this template. This library also provides default accessors for {\ttfamily std\+::pair$<$StampT, ValueT$>$}.
...
Additionally, you must provide a specialization of {\ttfamily \mbox{\hyperlink{structflow_1_1_dispatch_traits}{flow\+::\+Dispatch\+Traits}}}, which will be used to specify required type info used by {\ttfamily \mbox{\hyperlink{classflow_1_1_captor}{flow\+::\+Captor}}} objects\+:
...
If your associated sequence stamp type ({\ttfamily Stamp\+Type} in the example above) is not a \href{https://en.cppreference.com/w/cpp/types/is_integral}{\texttt{ non-\/integral}} type (excluding {\ttfamily bool}), then you must also specialize {\ttfamily \mbox{\hyperlink{structflow_1_1_stamp_traits}{flow\+::\+Stamp\+Traits}}}\+:
...
Captors utilize a {\ttfamily \mbox{\hyperlink{classflow_1_1_dispatch_queue}{flow\+::\+Dispatch\+Queue}}} for data ordering and retrieval. Users may supply a custom underlying container to manage this data. Refer to \href{https://en.cppreference.com/w/cpp/container/deque}{\texttt{ {\ttfamily std\+::deque}}} for more information on the listed requirements. The container type must supply the following\+:
...
\doxyparagraph*{{\ttfamily \mbox{\hyperlink{classflow_1_1driver_1_1_batch}{flow\+::driver\+::\+Batch}}}}
...
\doxyparagraph*{{\ttfamily \mbox{\hyperlink{classflow_1_1driver_1_1_chunk}{flow\+::driver\+::\+Chunk}}}}
...
\doxyparagraph*{{\ttfamily \mbox{\hyperlink{classflow_1_1driver_1_1_next}{flow\+::driver\+::\+Next}}}}
...
\doxyparagraph*{{\ttfamily \mbox{\hyperlink{classflow_1_1driver_1_1_throttled}{flow\+::driver\+::\+Throttled}}}}
...
\doxyparagraph*{{\ttfamily \mbox{\hyperlink{classflow_1_1follower_1_1_any_before}{flow\+::follower\+::\+Any\+Before}}}}
...
Capture will report a {\ttfamily \mbox{\hyperlink{namespaceflow_adefe9726e597eb50c46f0f6a202018e9a6eed4968877959d0209d9b75fdd16b52}{flow\+::\+State\+::\+P\+R\+I\+M\+ED}}} state even if the buffer is empty, making this captor the ideal choice if you are working with a data stream that is \char`\"{}optional\char`\"{} for the current synchronization attempt.
...
\doxyparagraph*{{\ttfamily \mbox{\hyperlink{classflow_1_1follower_1_1_before}{flow\+::follower\+::\+Before}}}}
...
\doxyparagraph*{{\ttfamily \mbox{\hyperlink{classflow_1_1follower_1_1_closest_before}{flow\+::follower\+::\+Closest\+Before}}}}
...
\doxyparagraph*{{\ttfamily \mbox{\hyperlink{classflow_1_1follower_1_1_count_before}{flow\+::follower\+::\+Count\+Before}}}}
...
\doxyparagraph*{{\ttfamily \mbox{\hyperlink{classflow_1_1follower_1_1_latched}{flow\+::follower\+::\+Latched}}}}
...
\doxyparagraph*{{\ttfamily \mbox{\hyperlink{classflow_1_1follower_1_1_matched_stamp}{flow\+::follower\+::\+Matched\+Stamp}}}}
...
\doxyparagraph*{{\ttfamily \mbox{\hyperlink{classflow_1_1follower_1_1_ranged}{flow\+::follower\+::\+Ranged}}}}
...
Follower Captors support customizable sync behavior through a \char`\"{}queue monitor\char`\"{}. Queue monitor objects are specified in the template argument list of a captor. If not specified, then a default, {\ttfamily \mbox{\hyperlink{structflow_1_1_default_dispatch_queue_monitor}{flow\+::\+Default\+Dispatch\+Queue\+Monitor}}}, is used with no additional overhead, assuming some form of basic compiler optimization enabled.
...
\begin{DoxyCode}{0}
\DoxyCodeLine{bazel test ... -\/-\/test\_output=all}
\end{DoxyCode}


Bazel isn\textquotesingle{}t everyone\textquotesingle{}s cup of tea. {\itshape cmake build to come later}; earlier contribution welcome. 