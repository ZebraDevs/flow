...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classflow_1_1_captor_interface__coll__graph}
\end{center}
\end{figure}
...
\mbox{\Hypertarget{classflow_1_1_captor_interface_ac20bee4222d841bb5c9dbcd4c838cb9f}\label{classflow_1_1_captor_interface_ac20bee4222d841bb5c9dbcd4c838cb9f}} 
using \mbox{\hyperlink{classflow_1_1_captor_interface_ac20bee4222d841bb5c9dbcd4c838cb9f}{Access\+Stamp\+Type}} = typename \mbox{\hyperlink{structflow_1_1_captor_traits}{Captor\+Traits}}$<$ CaptorT $>$\+::\mbox{\hyperlink{classflow_1_1_captor_interface_ac20bee4222d841bb5c9dbcd4c838cb9f}{Access\+Stamp\+Type}}
\begin{DoxyCompactList}\small\item\em Stamp access implementation. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{classflow_1_1_captor_interface_ae8a3e0c641441b1d283faf0baf1ea4c9}\label{classflow_1_1_captor_interface_ae8a3e0c641441b1d283faf0baf1ea4c9}} 
using \mbox{\hyperlink{classflow_1_1_captor_interface_ae8a3e0c641441b1d283faf0baf1ea4c9}{Access\+Value\+Type}} = typename \mbox{\hyperlink{structflow_1_1_captor_traits}{Captor\+Traits}}$<$ CaptorT $>$\+::\mbox{\hyperlink{classflow_1_1_captor_interface_ae8a3e0c641441b1d283faf0baf1ea4c9}{Access\+Value\+Type}}
\begin{DoxyCompactList}\small\item\em Value access implementation. \end{DoxyCompactList}\item 
...
{\footnotesize template$<$typename Output\+Dispatch\+IteratorT , typename Capture\+RangeT $>$ }\\std\+::tuple$<$ \mbox{\hyperlink{namespaceflow_adefe9726e597eb50c46f0f6a202018e9}{State}}, Output\+Dispatch\+IteratorT $>$ \mbox{\hyperlink{classflow_1_1_captor_interface_a85a1878d0ae10f621b1508d7ff8a231e}{capture}} (Output\+Dispatch\+IteratorT output, Capture\+RangeT \&\&range)
\begin{DoxyCompactList}\small\item\em Waits for ready state and captures inputs. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Output\+Dispatch\+IteratorT , typename Capture\+RangeT , typename ClockT , typename DurationT $>$ }\\std\+::tuple$<$ \mbox{\hyperlink{namespaceflow_adefe9726e597eb50c46f0f6a202018e9}{State}}, Output\+Dispatch\+IteratorT $>$ \mbox{\hyperlink{classflow_1_1_captor_interface_a0a0df19610464657956e4321072370b0}{capture}} (Output\+Dispatch\+IteratorT output, Capture\+RangeT \&\&range, const std\+::chrono\+::time\+\_\+point$<$ ClockT, DurationT $>$ timeout=std\+::chrono\+::time\+\_\+point$<$ ClockT, DurationT $>$\+::max())
\begin{DoxyCompactList}\small\item\em Waits for ready state and captures inputs. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Capture\+RangeT $>$ }\\std\+::tuple$<$ \mbox{\hyperlink{namespaceflow_adefe9726e597eb50c46f0f6a202018e9}{State}}, \mbox{\hyperlink{structflow_1_1_extraction_range}{Extraction\+Range}} $>$ \mbox{\hyperlink{classflow_1_1_captor_interface_a6815569fecf89d603d53d872cac776ea}{locate}} (Capture\+RangeT \&\&range)
\begin{DoxyCompactList}\small\item\em Finds element range to extract on synchronization. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Capture\+RangeT , typename ClockT , typename DurationT $>$ }\\std\+::tuple$<$ \mbox{\hyperlink{namespaceflow_adefe9726e597eb50c46f0f6a202018e9}{State}}, \mbox{\hyperlink{structflow_1_1_extraction_range}{Extraction\+Range}} $>$ \mbox{\hyperlink{classflow_1_1_captor_interface_acebec0256a3c716a681f05e70757d7c0}{locate}} (Capture\+RangeT \&\&range, const std\+::chrono\+::time\+\_\+point$<$ ClockT, DurationT $>$ timeout=std\+::chrono\+::time\+\_\+point$<$ ClockT, DurationT $>$\+::max())
\begin{DoxyCompactList}\small\item\em Finds element range to extract on synchronization. \end{DoxyCompactList}\item 
{\footnotesize template$<$typename Output\+Dispatch\+IteratorT $>$ }\\Output\+Dispatch\+IteratorT \mbox{\hyperlink{classflow_1_1_captor_interface_a62b4df4537021f6df3eb094150233bbf}{extract}} (Output\+Dispatch\+IteratorT output, const \mbox{\hyperlink{structflow_1_1_extraction_range}{Extraction\+Range}} \&extraction\+\_\+range, const \mbox{\hyperlink{structflow_1_1_capture_range}{Capture\+Range}}$<$ \mbox{\hyperlink{classflow_1_1_captor_interface_a2b87d20d17e8d1437941bd98fe514bc8}{stamp\+\_\+type}} $>$ \&range)
\begin{DoxyCompactList}\small\item\em Extracts elements from queue based on {\ttfamily extraction\+\_\+range} found via {\ttfamily locate}. \end{DoxyCompactList}\item 
...
\mbox{\Hypertarget{classflow_1_1_captor_interface_a767b9a444e37ea7bf523906bccfcd1dc}\label{classflow_1_1_captor_interface_a767b9a444e37ea7bf523906bccfcd1dc}} 
\mbox{\hyperlink{classflow_1_1_dispatch_queue}{Dispatch\+Queue}}$<$ \mbox{\hyperlink{classflow_1_1_captor_interface_ae1eafeb6cd50f4a50843b963c232720a}{Dispatch\+Type}}, \mbox{\hyperlink{classflow_1_1_captor_interface_a887171bf3b12d8232922a81844ea9a7d}{Dispatch\+Container\+Type}}, \mbox{\hyperlink{classflow_1_1_captor_interface_ac20bee4222d841bb5c9dbcd4c838cb9f}{Access\+Stamp\+Type}}, \mbox{\hyperlink{classflow_1_1_captor_interface_ae8a3e0c641441b1d283faf0baf1ea4c9}{Access\+Value\+Type}} $>$ \mbox{\hyperlink{classflow_1_1_captor_interface_a767b9a444e37ea7bf523906bccfcd1dc}{queue\+\_\+}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{classflow_1_1_captor_interface_a85a1878d0ae10f621b1508d7ff8a231e}\label{classflow_1_1_captor_interface_a85a1878d0ae10f621b1508d7ff8a231e}} 
...
std\+::tuple$<$\mbox{\hyperlink{namespaceflow_adefe9726e597eb50c46f0f6a202018e9}{State}}, Output\+Dispatch\+IteratorT$>$ \mbox{\hyperlink{classflow_1_1_captor_interface}{flow\+::\+Captor\+Interface}}$<$ CaptorT $>$\+::capture (\begin{DoxyParamCaption}\item[{Output\+Dispatch\+IteratorT}]{output,  }\item[{Capture\+RangeT \&\&}]{range }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}



Waits for ready state and captures inputs. 

This is used for capturing data from an individual \mbox{\hyperlink{classflow_1_1_captor}{Captor}}. This method calls a combination of {\ttfamily locate} and {\ttfamily extract}. This method is not used during multi-\/\+Captor synchronization
...
{\ttfamily \{capture directive code, output iterator\}} 
\end{DoxyReturn}
\mbox{\Hypertarget{classflow_1_1_captor_interface_a0a0df19610464657956e4321072370b0}\label{classflow_1_1_captor_interface_a0a0df19610464657956e4321072370b0}} 
\index{flow::CaptorInterface$<$ CaptorT $>$@{flow::CaptorInterface$<$ CaptorT $>$}!capture@{capture}}
\index{capture@{capture}!flow::CaptorInterface$<$ CaptorT $>$@{flow::CaptorInterface$<$ CaptorT $>$}}
...
std\+::tuple$<$\mbox{\hyperlink{namespaceflow_adefe9726e597eb50c46f0f6a202018e9}{State}}, Output\+Dispatch\+IteratorT$>$ \mbox{\hyperlink{classflow_1_1_captor_interface}{flow\+::\+Captor\+Interface}}$<$ CaptorT $>$\+::capture (\begin{DoxyParamCaption}\item[{Output\+Dispatch\+IteratorT}]{output,  }\item[{Capture\+RangeT \&\&}]{range,  }\item[{const std\+::chrono\+::time\+\_\+point$<$ ClockT, DurationT $>$}]{timeout = {\ttfamily std\+:\+:chrono\+:\+:time\+\_\+point$<$ClockT,~DurationT$>$\+:\+:max()} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{classflow_1_1_captor_interface_a62b4df4537021f6df3eb094150233bbf}\label{classflow_1_1_captor_interface_a62b4df4537021f6df3eb094150233bbf}} 
\index{flow::CaptorInterface$<$ CaptorT $>$@{flow::CaptorInterface$<$ CaptorT $>$}!extract@{extract}}
\index{extract@{extract}!flow::CaptorInterface$<$ CaptorT $>$@{flow::CaptorInterface$<$ CaptorT $>$}}
\doxysubsubsection{\texorpdfstring{extract()}{extract()}}
{\footnotesize\ttfamily template$<$typename CaptorT $>$ \\
template$<$typename Output\+Dispatch\+IteratorT $>$ \\
Output\+Dispatch\+IteratorT \mbox{\hyperlink{classflow_1_1_captor_interface}{flow\+::\+Captor\+Interface}}$<$ CaptorT $>$\+::extract (\begin{DoxyParamCaption}\item[{Output\+Dispatch\+IteratorT}]{output,  }\item[{const \mbox{\hyperlink{structflow_1_1_extraction_range}{Extraction\+Range}} \&}]{extraction\+\_\+range,  }\item[{const \mbox{\hyperlink{structflow_1_1_capture_range}{Capture\+Range}}$<$ \mbox{\hyperlink{classflow_1_1_captor_interface_a2b87d20d17e8d1437941bd98fe514bc8}{stamp\+\_\+type}} $>$ \&}]{range }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}



Extracts elements from queue based on {\ttfamily extraction\+\_\+range} found via {\ttfamily locate}. 
...
\mbox{\texttt{ out}}  & {\em output} & output data iterator \\
\hline
 & {\em extraction\+\_\+range} & range of elements to extract (by copy or move) from queue \\
\hline
 & {\em range} & data capture/sequencing range\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
{\ttfamily output} iterator, advanced if elements were extracted 
\end{DoxyReturn}
...
\begin{DoxyParams}{Parameters}
{\em args} & args forward to {\ttfamily \mbox{\hyperlink{classflow_1_1_dispatch_queue_a529bb9e9de63f0a33678e53254b97560}{Dispatch\+Queue\+::insert}}}\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{classflow_1_1_captor_interface_a6815569fecf89d603d53d872cac776ea}\label{classflow_1_1_captor_interface_a6815569fecf89d603d53d872cac776ea}} 
\index{flow::CaptorInterface$<$ CaptorT $>$@{flow::CaptorInterface$<$ CaptorT $>$}!locate@{locate}}
\index{locate@{locate}!flow::CaptorInterface$<$ CaptorT $>$@{flow::CaptorInterface$<$ CaptorT $>$}}
\doxysubsubsection{\texorpdfstring{locate()}{locate()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily template$<$typename CaptorT $>$ \\
template$<$typename Capture\+RangeT $>$ \\
std\+::tuple$<$\mbox{\hyperlink{namespaceflow_adefe9726e597eb50c46f0f6a202018e9}{State}}, \mbox{\hyperlink{structflow_1_1_extraction_range}{Extraction\+Range}}$>$ \mbox{\hyperlink{classflow_1_1_captor_interface}{flow\+::\+Captor\+Interface}}$<$ CaptorT $>$\+::locate (\begin{DoxyParamCaption}\item[{Capture\+RangeT \&\&}]{range }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}



Finds element range to extract on synchronization. 
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
{\ttfamily \{capture directive code, element range\}} 
\end{DoxyReturn}
\mbox{\Hypertarget{classflow_1_1_captor_interface_acebec0256a3c716a681f05e70757d7c0}\label{classflow_1_1_captor_interface_acebec0256a3c716a681f05e70757d7c0}} 
\index{flow::CaptorInterface$<$ CaptorT $>$@{flow::CaptorInterface$<$ CaptorT $>$}!locate@{locate}}
\index{locate@{locate}!flow::CaptorInterface$<$ CaptorT $>$@{flow::CaptorInterface$<$ CaptorT $>$}}
\doxysubsubsection{\texorpdfstring{locate()}{locate()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily template$<$typename CaptorT $>$ \\
template$<$typename Capture\+RangeT , typename ClockT , typename DurationT $>$ \\
std\+::tuple$<$\mbox{\hyperlink{namespaceflow_adefe9726e597eb50c46f0f6a202018e9}{State}}, \mbox{\hyperlink{structflow_1_1_extraction_range}{Extraction\+Range}}$>$ \mbox{\hyperlink{classflow_1_1_captor_interface}{flow\+::\+Captor\+Interface}}$<$ CaptorT $>$\+::locate (\begin{DoxyParamCaption}\item[{Capture\+RangeT \&\&}]{range,  }\item[{const std\+::chrono\+::time\+\_\+point$<$ ClockT, DurationT $>$}]{timeout = {\ttfamily std\+:\+:chrono\+:\+:time\+\_\+point$<$ClockT,~DurationT$>$\+:\+:max()} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\item 
include/flow/captor.\+hpp\item 
include/flow/impl/captor\+\_\+interface.\+hpp\end{DoxyCompactItemize}
